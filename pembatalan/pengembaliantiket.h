...
void BatalTiket() {
    ...
    do {
        ...
        gotoxy(95, 35); printf("KONFIRMASI PEMBATALAN");
        ...
        while (1) {
            ...
            if (confirm == 'Y' || confirm == 'y') {
                ...
                gotoxy(87, 29); printf("Status         : Batal");
                gotoxy(87, 30); printf("ID Pembatalan  : %s", id_pembatalan);
                gotoxy(87, 31); printf("Tiket berhasil dibatalkan!");
                gotoxy(87, 32); printf("Batalkan lagi? (y/n): ");
